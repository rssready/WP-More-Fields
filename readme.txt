=== Why Fork? ===
It seems as if development on all the "More" family of plugins as completely stopped. It is understandable the original devs have moved on to bigger, better things. The only problem is that many people still use these plugins. In order to keep development alive, we have set up this fork. Hopefully, it will helpful to others.
